...
class MainActivity : AppCompatActivity(), de.brainlezz.circlebuttons.CircleButtonView.OnElementClickedListener, de.brainlezz.circlebuttons.CircleButtonView.IconProvider {
