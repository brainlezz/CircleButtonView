package de.brainlezz.circlebuttons
...
class CircleButtonView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    companion object{
        ...
        const val LOG_TAG = "CircleButtonView"
    }
    ...
    var angleOffset = DEFAULT_ANGLE_OFFSET
        set(value) {
            if(value >= 0 && value < 360) {
                ...
                Log.e(LOG_TAG,"Angle Offset has to be between 0 and 360!")
            }
        }
    var circleElementCount = DEFAULT_CIRCLE_ELEMENT_COUNT
        set(value) {
            if(value >= 2) {
                ...
                Log.e(LOG_TAG,"At least two elements are needed!")
            }
        }
    ...
    var innerCirclePortion: Int = DEFAULT_INNER_CIRCLE_PORTION
        set(value) {
            if(value in 10..90) {
                ...
                Log.e(LOG_TAG,"For a resonable result the inner circle portion should be between 10 and 90%!")
            }
        }
